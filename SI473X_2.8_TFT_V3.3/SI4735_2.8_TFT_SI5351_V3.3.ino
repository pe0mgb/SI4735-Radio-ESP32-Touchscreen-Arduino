...
void setup() {
  ...
  //si5351wire.set_freq(1000000000UL, CLK_Xtal); // used for calibrating 
  //si5351wire.set_correction(93334UL, SI5351wire_PLL_INPUT_XO);  // #3
  //si5351wire.set_correction(77976UL, SI5351wire_PLL_INPUT_XO);  // #R
  //si5351wire.set_correction(76063UL, SI5351wire_PLL_INPUT_XO);  // #2  4732 proto
  si5351wire.set_correction(0, SI5351wire_PLL_INPUT_XO);
  //si5351wire.set_correction(26613UL, SI5351wire_PLL_INPUT_XO);  // #1  4732
  si5351wire.set_freq(FreqSI5351, CLK_Xtal);
  //si5351wire.set_freq(707400000UL,SI5351wire_CLK1 );
#endif
...
//=======================================================================================
  ...
  tft.setCursor(0, 0);
  tft.setTextColor(TFT_YELLOW, TFT_BLACK);
  tft.drawString("Software version V3.2.6b",5,10);
