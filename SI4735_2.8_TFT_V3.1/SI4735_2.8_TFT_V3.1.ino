//  V3.1 27-07-2021 Added Sprite buttons from Jim Yasuda.
//                  Add noise surpression during 1kHz frequency change in SSB.
...
const char *Keypathtext[]  = {"1", "2", "3", "4", "5", "6", "7", "8", "9", ".", "0", "SET", "Clear"};
...
//=======================================================================================
  ...
  Serial.println("Version 3.1 27-07-2021");
  tft.println("SI4735  Radio");
  tft.setCursor(7, 70);
  tft.println(" Version 3.1");
  tft.setCursor(7, 95);
  tft.println(" 27-07-2021");
  tft.setCursor(7, 130);
  delay(1000);
...
//=======================================================================================
    ...
    tft.drawString("Power Supply : " + String(((3.3/4095) * vsupply) * 2) + " V.", 5, 180);
    while (x == 0) {
